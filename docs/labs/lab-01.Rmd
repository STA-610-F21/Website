...
The data are in the file [fruitfly_thorax_len.csv](https://sta610-f21.olanrewajuakande.com/labs/data/fruitfly_thorax_len.csv), which contains lifespan, thorax length, and sexual activity for male fruit flies in the experiment.
