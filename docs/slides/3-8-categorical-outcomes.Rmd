...
.block[
.small[
$$\textrm{log}\left(\dfrac{\Pr[y_i \leq k| x_i]}{\Pr[y_i > k| x_i]}\right) = \beta_{0j} + \beta_{1} x_{i1}, \ \ \ k = 1, \ldots, 4,$$
]
]
...
Then,
  + For any $k$, $\beta_{1}$ is the log-odds of a Democrat, when compared to a Republican, of .hlight[being more conservative] than $j$ .hlight[compared to being more liberal] than $j$.

  + For any $k$, $e^{\beta_{1}}$ is the odds of a Democrat, when compared to a Republican, of .hlight[being more conservative] than $j$ .hlight[compared to being more liberal] than $j$.
